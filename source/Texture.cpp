...
SDL_RWops* Texture::atlas_file = nullptr;
...
SDL_Surface* Texture::loadAtlasSurface() {
    atlas_file = SDL_RWFromConstMem(data_textureAtlas, data_textureAtlas_size);
    atlas_surface = IMG_Load_RW(atlas_file, 1);
...
SDL_Texture* Texture::loadTexture(int texture_id) {
    atlas_texture = NULL;
